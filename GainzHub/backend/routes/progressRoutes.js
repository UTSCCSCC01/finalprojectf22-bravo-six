...
const {privateBodyWeight, unPrivateBodyWeight, addBodyWeight, getBodyWeight, getIndividualBodyWeight, addBMI, getBMI, getIndividualBMI, addBF, getBF, getIndividualBF} = require("../controllers/progressController");
...
router.patch("/privateBodyWeight", privateBodyWeight);
router.patch("/unPrivateBodyWeight", unPrivateBodyWeight);
